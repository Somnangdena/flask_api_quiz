const quizData = [
  ...
  {
    question: 'Which planet is known for its large red storm, known as the Great Red Spot?',
    options: [
      'Earth',
      'Saturn',
      'Jupiter',
  ...
  {
    question: 'What is the force that keeps the planets in orbit around the Sun?',
    options: [
      'Magnetism', 
